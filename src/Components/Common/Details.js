    ...
    <div className="details-main">
      <div>
        ...
        <p>
          ...
          suit your specific needs, ensuring that you get the most out of our
          services without burning a hole in your budget.
        </p>
      </div>
      <div>
        <h1>The Power of Easy-to-Understand Words</h1>
        <p>
          We understand that not everyone is well-versed in technical jargon.
          That's why we've made it a priority to present our services in simple,
          easy-to-understand language. You don't need to be an AI expert to make
          the most of our tools. Our user-friendly interface and intuitive
          features make it effortless for anyone to navigate and utilize our
