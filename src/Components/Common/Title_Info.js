    ...
    <Card sx={{ minWidth: 275 }}>
      <CardContent>
        ...
        <div className="title-info-main">
          <h1>Discover the Power of Affordable AI with Faisaliteb AI</h1>
          <p>
            Welcome to faisaliteb.ai, your go-to destination for harnessing the
            power of affordable AI solutions. Our cutting-edge technology
            combines the prowess of advanced algorithms and machine learning to
            empower businesses with top-notch content generation and copyright
            generation tools. From our versatile 123-ai content writer to our
            magical text generators, we have everything you need to streamline
